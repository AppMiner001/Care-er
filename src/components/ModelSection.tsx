        ...
        <div className="grid lg:grid-cols-[1fr_1.7fr] gap-16 lg:gap-36 items-start">
          ...
          <div className="lg:sticky lg:top-36">
            <div ref={headingRef} data-reveal>
              <p className="eyebrow text-[var(--color-ink)]/55 mb-10">
                Modellen
              </p>
              <h2
              ...
              <p
                className="mt-6 text-[var(--color-ink)]/65 leading-relaxed max-w-[22ch] text-pretty"
...
function StepRow({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden
        className="absolute right-0 top-1/2 -translate-y-1/2 text-[var(--color-ink)]/[0.05] font-bold leading-none pointer-events-none select-none"
        style={{
      ...
      <div className="relative grid grid-cols-[3rem_1fr] gap-x-8 items-start">
        ...
        <div>
          ...
          <p
            className="mt-6 text-[var(--color-ink)]/65 leading-snug"
            style={{ fontSize: "clamp(1.05rem, 1.6vw, 1.25rem)", fontWeight: 300 }}
          >
            {step.line1}
          </p>
          <p
            className="mt-2 text-[var(--color-ink)]/45"
